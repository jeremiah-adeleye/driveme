                ...
                <form method="post" >
                    ...
                    <div class="row" >
                        <div class="form-group custom col-md-6" id="first-name-input" >
                            ...
                            <input type="text" class="form-control input-custom-primary" id="first-name" name="firstName" aria-describedby="firstName">
                        </div>

                        <div class="form-group custom col-md-6" id="last-name-input" >
                            <label for="last-name">Last Name</label>
                            <input type="text" class="form-control input-custom-primary" id="last-name" name="lastName"  aria-describedby="lastName">
                        </div>
                        ...
                        <div class="form-group custom col-md-6" id="phone-number-input" >
                            ...
                            <input type="tel" class="form-control input-custom-primary" id="phone-number" aria-describedby="phoneNumber">
                        </div>

                        <div class="form-group custom col-md-6" id="dob-input" >
                            <label for="dob">Date of Birth</label>
                            <input type="date" class="form-control input-custom-primary" id="dob" aria-describedby="dateOfBirth">
                        </div>

                        <div class="form-group custom col-md-6" id="location-input" >
                            <label for="location">Location</label>
                            <input type="text" class="form-control input-custom-primary" id="location" aria-describedby="location">
                        </div>

                        <div class="form-group custom col-md-6" id="location-input" >
                            <label for="salary-range">Salary Range <small>(amount you want to be paid)</small></label>
                            <input type="text" class="form-control input-custom-primary" id="salary-range" aria-describedby="salaryRange">
                        </div>
                        ...
                        <div class="form-group custom col-md-6" id="address-input" >
                            ...
                            <input type="text" class="form-control input-custom-primary" id="address" aria-describedby="address">
                        </div>

                        <div class="form-group custom col-md-6" id="licence-number-input" >
                            <label for="licence-number">Licence Number</label>
                            <input type="text" class="form-control input-custom-primary" id="licence-number" aria-describedby="licenceNumber">
                        </div>

                        <div class="form-group custom col-md-6" id="experience-input" >
                            <label for="experience">Driver’s Experience Years</label>
                            <input type="number" class="form-control input-custom-primary" id="experience" aria-describedby="experience">
                        </div>

                        <div class="form-group custom col-md-6" id="licence-number-input" >
                            <label for="car-type">What kind of Vehicle do you drive?</label>
                            <input type="text" class="form-control input-custom-primary" id="car-type" aria-describedby="carType">
                        </div>
