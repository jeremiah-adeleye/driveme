...
@section('content')
    <section id="dashboard-section" class="d-flex flex-column" >
        ...
        <div class="row my-auto">
            <div class="col-md-4" >
                <div class="form-group custom col-md-10 text-center dv-image-input" id="passport-input" >
                    <label for="passport" class="input-label passport-placeholder" data-target="#passport" ></label><br>
                    <label for="passport">Tap to change Picture</label>
